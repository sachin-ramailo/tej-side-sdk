...
import 'package:sdk_app/src/account.dart';
...
getBalance() async {
  ...
  EtherAmount etherAmount = await accountsUtil.getBalance();
  print(etherAmount.getInEther);
}
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Center(
        ...
        child: FutureBuilder(
          future: AccountsUtil.getInstance().getAccountPhrase(),
            ...
            if(snapshot.hasData){
              return Column(
                ...
                children: <Widget>[
                  ...
                  TextButton(
                    onPressed: () {
                      AccountsUtil.getInstance().createAccount();
                    },
                    child: const Text(
                      "Create wallet",
                    ),
